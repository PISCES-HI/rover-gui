...
fn main() {
    ...
    let (mut video0_texture, video0_image) = start_video_stream("rtsp://10.14.120.26/axis-media/media.amp");
    let (mut video1_texture, video1_image) = start_video_stream("rtsp://10.14.120.27/axis-media/media.amp");
    let (mut video2_texture, video2_image) = start_video_stream("rtsp://root:pisces@10.14.120.28/axis-media/media.amp");

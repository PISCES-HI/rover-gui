...
fn main() {
    ...
    socket.send_to(b"connect me plz", ("10.10.153.8", 30001));
    ...
    let (mut video_texture, video_image) = start_video_stream("rtsp://root:pisces@10.10.153.11/axis-media/media.amp", None);
